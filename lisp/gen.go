...
func F_funcall_ed9203b2eada2243af7c81cb83b2c525(e, a, op, first, second, third Exp) Exp {
	return A(eval, A(funcall, e, a), a)
}
...
var map_29 = make(map[string]func(x, first, rest Exp) Exp)

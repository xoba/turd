					...
					λ = func(args ...Exp) Exp {
						...
						return func() Exp {
							...
							λ = func(args ...Exp) Exp {
								...
								third := args[1]
								return func() Exp {
									if f, ok := map_5de2f2176d[String(op)]; ok {
...
var map_5de2f2176d = make(map[string]func(a, e, first, op, rest, second, third Exp) Exp)

func init() {
	map_5de2f2176d = map[string]func(a, e, first, op, rest, second, third Exp) Exp{

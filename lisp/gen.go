					...
					λ = func(args ...Exp) Exp {
						...
						return func() Exp {
							...
							λ = func(args ...Exp) Exp {
								...
								third := args[1]
								return func() Exp {
									if f, ok := map_a365e89649[String(op)]; ok {
...
var map_a365e89649 = make(map[string]func(a, e, first, op, rest, second, third Exp) Exp)

func init() {
	map_a365e89649 = map[string]func(a, e, first, op, rest, second, third Exp) Exp{

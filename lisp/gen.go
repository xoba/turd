...
var env_xappend = []Exp{quote("xappend"), []Exp{quote("label"), quote("xappend"), []Exp{quote("lambda"), []Exp{quote("x"), quote("y")}, []Exp{quote("cond"), []Exp{[]Exp{quote("null"), quote("x")}, quote("y")}, []Exp{[]Exp{quote("quote"), quote("t")}, []Exp{quote("cons"), []Exp{quote("car"), quote("x")}, []Exp{quote("xappend"), []Exp{quote("cdr"), quote("x")}, quote("y")}}}}}}}
